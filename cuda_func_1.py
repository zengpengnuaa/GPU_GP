...
def cudafunc(imgs, ret_vectors):
    ...
    innerfunc = lambda ARG0: concat(neg(protected_div(std(regionr(ARG0, 13, 21, 51, 41)), std(ARG0))), std(ARG0), mean(ARG0), mean(ARG0), mean(ARG0), std(conv(regions(ARG0, 22, 13, 26), gen_filter(3, 'sharpen'))), std(maxP(ARG0, 2, 4)), protected_div(std(maxP(ARG0, 4, 4)), std(ARG0)), sub(ARG0, 35, 49, 20, 32), protected_div(std(maxP(ARG0, 4, 2)), std(ARG0)))
